...
export const metadata: Metadata = {
  title: 'Funnel Ads — Save over 85% on your first month',
  description:
    'Clear aligners planned in person and signed by a named, GDC-registered dentist. Prices published, from £895.',
};

/**
 * Funnel Ads — a duplicate of the funnel page (same sections/order). The
 * `funnel-ads` class on the wrapper scopes any ads-specific styling overrides
 * (applied to match the Figma "Funnel Ads" frame) without touching /funnel.
 */
