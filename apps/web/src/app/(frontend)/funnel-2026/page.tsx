...
// New navigation + hero (MOVES brand system)
...
export default function Funnel2026Page() {
  return (
    <>
      {/* Kept outside the funnel wrapper: FunnelReveal animates that
          wrapper's direct children, and the new hero has its own entrance. */}
      <div className="mv">
        <Header />
        <Hero />
      </div>
      <div className="moves-page funnel-page funnel-2026">
        ...
        <Faqs
          data={{
            ...
            description: 'Find answers to common questions about MOVES, answered by our experts.',
