...
/* "Free Smile Assessment Appointment" (Figma 413:17402) — a full-bleed navy card
   with the aligner-case photo baked into the background; heading, lead, coral CTA
   and three badge chips (white disc + dark icon) sit overlaid on the left. */

const CHIPS = [
  {
    label: 'Expert & friendly dental team',
    icon: (
  ...
  {
    label: 'Personalized Treatment options',
    icon: (
      <svg viewBox="0 0 30 30" width="20" height="20" fill="none" aria-hidden="true">
        <path
  ...
  {
    label: 'Clear, comfortable results',
    icon: (
...
export function FreeAssessment() {
  return (
    <section className="ca-assess">
      {/* mobile-only: the aligner-case photo at the top of the card (desktop shows
          the navy scene as the section background instead) */}
      {/* eslint-disable-next-line @next/next/no-img-element */}
      <img className="ca-assess__photo" src="/images/ca-assess-mobile.png" alt="A MOVES clear-aligner case" />
      <div className="ca-assess__inner">
        <div className="ca-assess__col">
          <div className="ca-assess__intro">
            <h2 className="ca-assess__title">
              Free smile assessment <span className="ca-assess__accent">appointment</span>
            </h2>
            <p className="ca-assess__lead">
              Meet our friendly dental team to discuss your smile concerns, understand your treatment
              goals, and explore whether clear aligners, composite bonding, or a combination of both
              is right for you.
            </p>
          </div>
